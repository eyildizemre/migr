...
TARGET = migr
VPATH = src
SRCS = main.c detect.c report.c backup.c backup_plan.c packages.c restore.c utils.c fileops.c fsprobe.c xdg.c manifest.c encoding.c container.c metadata.c metadata_xattr.c portable_hashset.c portable_prescan.c portable_fsops.c portable.c portable_restore.c portable_restore_shared.c portable_restore_orchestrate.c sidecar.c sidecar_state.c sidecar_state_map.c hash.c
OBJS = $(SRCS:.c=.o)
...
$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore.o portable_restore.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_restore_dispatch.c restore.o portable_restore.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o

$(TEST_RESTORE_ATIME): tests/test_restore_atime.c restore.o portable_restore.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o backup_plan.o packages.o
...
portable_restore_test.o: src/portable_restore.c src/portable_restore.h src/portable_restore_internal.h src/portable_restore_replay_internal.h src/backup.h src/fsprobe.h src/sidecar.h src/manifest.h src/metadata.h src/encoding.h src/xdg.h
...
$(TEST_PORTABLE_RESTORE_PREFLIGHT): tests/test_portable_restore_preflight.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_preflight.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o

$(TEST_PORTABLE_RESTORE_REPLAY): tests/test_portable_restore_replay.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
	$(CC) $(CFLAGS) -Wl,--wrap=syncfs -o $@ tests/test_portable_restore_replay.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o

$(TEST_PORTABLE_RESTORE_ORCHESTRATE): tests/test_portable_restore_orchestrate.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup_test.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_orchestrate.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup_test.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o

$(TEST_PORTABLE_RESTORE_INVARIANT): tests/test_portable_restore_invariant.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_invariant.c portable_restore_test.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
...
clean:
	rm -f $(OBJS) report_test.o backup_test.o fileops_test.o sidecar.o sidecar_test.o sidecar_state.o sidecar_state_map.o sidecar_state_test.o sidecar_state_map_test.o portable.o portable_fsops.o portable_test.o portable_hashset.o portable_prescan.o portable_restore_test.o portable_restore_shared.o portable_restore_orchestrate.o metadata_test.o metadata_xattr.o $(TARGET) $(TEST_DETECT) $(TEST_REPORT) $(TEST_PATHJOIN) $(TEST_FD_LIMIT) $(TEST_SPECIAL_FILES) $(TEST_FSPROBE) $(TEST_MANIFEST) $(TEST_ENCODING) $(TEST_CONTAINER) $(TEST_RESTORE_NATIVE) $(TEST_RESTORE_SYNC) $(TEST_RESTORE_SOURCE_READ) $(TEST_BACKUP_SOURCE_READ) $(TEST_BACKUP_SYNC) $(TEST_RESTORE_DISPATCH) $(TEST_RESTORE_ATIME) $(TEST_BACKUP_PLAN) $(TEST_METADATA_CONTRACT) $(TEST_SIDECAR) $(TEST_SIDECAR_STATE) $(TEST_SIDECAR_SCALE) $(TEST_PORTABLE_CAPTURE) $(TEST_PORTABLE_CAPTURE_SCALE) $(TEST_PORTABLE_PREPARE) $(TEST_NATIVE_RECONCILE_SCALE) $(TEST_NATIVE_HARDLINK_SCALE) $(TEST_PORTABLE_COLLISION_SCALE) $(TEST_PORTABLE_HARDLINK_SCALE) $(TEST_PORTABLE_RESUME) $(TEST_PORTABLE_RECONCILE) $(TEST_PORTABLE_RECONCILE_SCALE) $(TEST_PORTABLE_RESTORE_PREFLIGHT) $(TEST_PORTABLE_RESTORE_REPLAY) $(TEST_PORTABLE_RESTORE_ORCHESTRATE) $(TEST_PORTABLE_RESTORE_INVARIANT)
