...
$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore.o portable_restore_replay.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o
...
$(TEST_BACKUP_PLAN): tests/test_backup_plan.c backup_test.o backup_plan_test.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -DBACKUP_PLAN_TEST_HOOKS -o $@ tests/test_backup_plan.c backup_test.o backup_plan_test.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
...
$(TEST_PORTABLE_RESTORE_ORCHESTRATE): tests/test_portable_restore_orchestrate.c portable_restore_replay_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup_test.o backup_plan.o container.o fileops.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
