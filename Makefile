...
TARGET = migr
VPATH = src
SRCS = main.c detect.c report.c backup.c backup_plan.c packages.c restore.c utils.c fileops.c fsprobe.c xdg.c manifest.c encoding.c container.c metadata.c metadata_xattr.c portable_hashset.c portable_prescan.c portable.c portable_restore.c sidecar.c sidecar_state.c sidecar_state_map.c hash.c
OBJS = $(SRCS:.c=.o)
...
$(TEST_SPECIAL_FILES): tests/test_special_files.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -DFILEOPS_TEST_HOOKS -DBACKUP_TEST_HOOKS -o $@ tests/test_special_files.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
...
$(TEST_RESTORE_NATIVE): tests/test_restore_native.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_native.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o

$(TEST_RESTORE_SYNC): tests/test_restore_sync.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -Wl,--wrap=syncfs -o $@ tests/test_restore_sync.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
...
$(TEST_RESTORE_SOURCE_READ): tests/test_restore_source_read.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -DFILEOPS_TEST_HOOKS -o $@ tests/test_restore_source_read.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
...
$(TEST_BACKUP_SOURCE_READ): tests/test_backup_source_read.c backup_test.o backup_plan.o container.o fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_backup_source_read.c backup_test.o backup_plan.o container.o fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o

$(TEST_BACKUP_SYNC): tests/test_backup_sync.c fileops_test.o portable_test.o portable_prescan.o portable_hashset.o metadata.o metadata_xattr.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -Wl,--wrap=syncfs -Wl,--wrap=read -o $@ tests/test_backup_sync.c fileops_test.o portable_test.o portable_prescan.o portable_hashset.o metadata.o metadata_xattr.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o

$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore.o portable_restore.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_restore_dispatch.c restore.o portable_restore.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o

$(TEST_RESTORE_ATIME): tests/test_restore_atime.c restore.o portable_restore.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o backup_plan.o packages.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_atime.c restore.o portable_restore.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o backup_plan.o packages.o

$(TEST_BACKUP_PLAN): tests/test_backup_plan.c backup_test.o backup_plan.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_backup_plan.c backup_test.o backup_plan.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o

$(TEST_METADATA_CONTRACT): tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
...
$(TEST_PORTABLE_CAPTURE): tests/test_portable_capture.c portable.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_capture.c portable.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

portable_test.o: src/portable.c src/portable.h src/sidecar.h src/portable_hashset_internal.h src/portable_prescan_internal.h
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -c src/portable.c -o $@

$(TEST_PORTABLE_CAPTURE_SCALE): tests/test_portable_capture_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_capture_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

$(TEST_PORTABLE_PREPARE): tests/test_portable_prepare.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -DSIDECAR_TEST_HOOKS -o $@ tests/test_portable_prepare.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

$(TEST_NATIVE_RECONCILE_SCALE): tests/test_native_reconcile_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -DNATIVE_VISITED_TEST_HOOKS -o $@ tests/test_native_reconcile_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o

$(TEST_NATIVE_HARDLINK_SCALE): tests/test_native_hardlink_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -DNATIVE_VISITED_TEST_HOOKS -o $@ tests/test_native_hardlink_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o

$(TEST_PORTABLE_COLLISION_SCALE): tests/test_portable_collision_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_collision_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

$(TEST_PORTABLE_HARDLINK_SCALE): tests/test_portable_hardlink_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_hardlink_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

sidecar_test.o: src/sidecar.c src/sidecar.h
	$(CC) $(CFLAGS) -DSIDECAR_TEST_HOOKS -c src/sidecar.c -o $@

$(TEST_PORTABLE_RESUME): tests/test_portable_resume.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -DSIDECAR_TEST_HOOKS -o $@ tests/test_portable_resume.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

$(TEST_PORTABLE_RECONCILE): tests/test_portable_reconcile.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_reconcile.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o

$(TEST_PORTABLE_RECONCILE_SCALE): tests/test_portable_reconcile_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_reconcile_scale.c portable_test.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o
