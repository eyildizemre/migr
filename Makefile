...
$(TEST_PORTABLE_HARDLINK_SCALE): tests/test_portable_hardlink_scale.c portable_test.o sidecar.o sidecar_state_test.o manifest.o encoding.o metadata.o utils.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_hardlink_scale.c portable_test.o sidecar.o sidecar_state_test.o manifest.o encoding.o metadata.o utils.o
