...
$(TEST_METADATA_CONTRACT): tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o
...
portable_restore_replay_test.o: src/portable_restore_replay.c src/portable_restore.h src/portable_restore_internal.h src/portable_restore_replay_internal.h src/backup.h src/manifest.h src/metadata.h src/portable.h src/sidecar.h src/utils.h
	$(CC) $(CFLAGS) -c src/portable_restore_replay.c -o $@
