...
$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore.o portable_restore.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_restore_dispatch.c restore.o portable_restore.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o backup_plan.o packages.o

$(TEST_RESTORE_ATIME): tests/test_restore_atime.c restore.o portable_restore.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o backup_plan.o packages.o
...
$(TEST_PORTABLE_RESTORE_INVARIANT): tests/test_portable_restore_invariant.c portable_restore_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_invariant.c portable_restore_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o xdg.o backup.o backup_plan.o container.o fileops.o portable.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o
