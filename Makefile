...
TARGET = migr
VPATH = src
SRCS = main.c detect.c report.c backup.c backup_plan.c packages.c restore.c utils.c fileops.c fsprobe.c xdg.c manifest.c encoding.c container.c metadata.c portable.c sidecar.c sidecar_state.c hash.c
OBJS = $(SRCS:.c=.o)
...
$(TEST_PORTABLE_RESTORE_PREFLIGHT): tests/test_portable_restore_preflight.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_preflight.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o

$(TEST_PORTABLE_RESTORE_REPLAY): tests/test_portable_restore_replay.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_replay.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o

$(TEST_PORTABLE_RESTORE_ORCHESTRATE): tests/test_portable_restore_orchestrate.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_orchestrate.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o

$(TEST_PORTABLE_RESTORE_INVARIANT): tests/test_portable_restore_invariant.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_invariant.c portable_restore_test.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
