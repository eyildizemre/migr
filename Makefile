...
$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore.o fileops.o metadata.o portable.o sidecar.o sidecar_state.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_dispatch.c restore.o fileops.o metadata.o portable.o sidecar.o sidecar_state.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o

$(TEST_RESTORE_ATIME): tests/test_restore_atime.c restore.o fileops.o metadata.o portable.o sidecar.o sidecar_state.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_atime.c restore.o fileops.o metadata.o portable.o sidecar.o sidecar_state.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o
...
portable_restore_test.o: src/portable_restore.c src/portable_restore.h src/fsprobe.h src/sidecar.h src/manifest.h src/metadata.h src/encoding.h
...
$(TEST_PORTABLE_RESTORE_PREFLIGHT): tests/test_portable_restore_preflight.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_preflight.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o

$(TEST_PORTABLE_RESTORE_REPLAY): tests/test_portable_restore_replay.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_replay.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o

$(TEST_PORTABLE_RESTORE_ORCHESTRATE): tests/test_portable_restore_orchestrate.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_orchestrate.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata_test.o utils.o

$(TEST_PORTABLE_RESTORE_INVARIANT): tests/test_portable_restore_invariant.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_restore_invariant.c portable_restore_test.o fsprobe.o sidecar.o sidecar_state.o hash.o manifest.o encoding.o metadata.o utils.o
