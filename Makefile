...
$(TEST_BACKUP_SOURCE_READ): tests/test_backup_source_read.c backup_test.o selfcopy.o backup_plan.o container.o fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
...
$(TEST_BACKUP_PLAN): tests/test_backup_plan.c backup_test.o selfcopy.o backup_plan_test.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -DBACKUP_PLAN_TEST_HOOKS -o $@ tests/test_backup_plan.c backup_test.o selfcopy.o backup_plan_test.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o
