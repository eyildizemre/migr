...
$(TEST_PACKAGES): tests/test_packages.c packages.o fileops.o detect.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -Wl,--wrap=malloc -o $@ tests/test_packages.c packages.o fileops.o detect.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_XDG): tests/test_xdg.c xdg.o utils.o
	$(CC) $(CFLAGS) -o $@ tests/test_xdg.c xdg.o utils.o

$(TEST_GET_DIR_SIZE): tests/test_get_dir_size.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_get_dir_size.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_PORTABLE_HASHSET): tests/test_portable_hashset.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_hashset.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_RUN_COMMAND): tests/test_run_command.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -Wl,--wrap=read -o $@ tests/test_run_command.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_SPECIAL_FILES): tests/test_special_files.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DFILEOPS_TEST_HOOKS -DBACKUP_TEST_HOOKS -Wl,--wrap=readlink -o $@ tests/test_special_files.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
...
$(TEST_RESTORE_NATIVE): tests/test_restore_native.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_native.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_RESTORE_SYNC): tests/test_restore_sync.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -Wl,--wrap=syncfs -o $@ tests/test_restore_sync.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
...
$(TEST_RESTORE_SOURCE_READ): tests/test_restore_source_read.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DFILEOPS_TEST_HOOKS -o $@ tests/test_restore_source_read.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
...
$(TEST_BACKUP_SOURCE_READ): tests/test_backup_source_read.c backup_test.o selfcopy.o backup_plan.o selection.o container.o fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o selection_match.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -o $@ tests/test_backup_source_read.c backup_test.o selfcopy.o backup_plan.o selection.o container.o fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o selection_match.o

$(TEST_BACKUP_SYNC): tests/test_backup_sync.c fileops_test.o portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o metadata.o metadata_xattr.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -Wl,--wrap=syncfs -Wl,--wrap=read -o $@ tests/test_backup_sync.c fileops_test.o portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o metadata.o metadata_xattr.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_RESTORE_DISPATCH): tests/test_restore_dispatch.c restore_test.o portable_restore_replay.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o selfcopy.o backup_plan.o selection.o packages.o selection_match.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -DRESTORE_TEST_HOOKS -o $@ tests/test_restore_dispatch.c restore_test.o portable_restore_replay.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup_test.o selfcopy.o backup_plan.o selection.o packages.o selection_match.o

$(TEST_RESTORE_ATIME): tests/test_restore_atime.c restore.o portable_restore_replay.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o selfcopy.o backup_plan.o selection.o packages.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_restore_atime.c restore.o portable_restore_replay.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o container.o utils.o xdg.o detect.o backup.o selfcopy.o backup_plan.o selection.o packages.o selection_match.o

$(TEST_BACKUP_PLAN): tests/test_backup_plan.c backup_test.o selfcopy.o backup_plan_test.o selection.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o selection_match.o
	$(CC) $(CFLAGS) -DBACKUP_TEST_HOOKS -DBACKUP_PLAN_TEST_HOOKS -o $@ tests/test_backup_plan.c backup_test.o selfcopy.o backup_plan_test.o selection.o container.o fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o fsprobe.o manifest.o encoding.o packages.o utils.o xdg.o detect.o selection_match.o

$(TEST_METADATA_CONTRACT): tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr_test.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DMETADATA_XATTR_TEST_HOOKS -o $@ tests/test_metadata_contract.c fileops.o metadata.o metadata_xattr_test.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_METADATA_SNAPSHOTS): tests/test_metadata_snapshots.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_metadata_snapshots.c fileops.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
...
$(TEST_PORTABLE_CAPTURE): tests/test_portable_capture.c portable.o portable_reconcile.o portable_fsops.o portable_prescan_test.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DPORTABLE_PRESCAN_TEST_HOOKS -o $@ tests/test_portable_capture.c portable.o portable_reconcile.o portable_fsops.o portable_prescan_test.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
...
portable_prescan_test.o: src/portable_prescan.c src/portable.h src/sidecar.h src/portable_prescan_internal.h src/portable_hashset_internal.h src/portable_fsops_internal.h src/encoding.h src/utils.h
	$(CC) $(CFLAGS) -DPORTABLE_PRESCAN_TEST_HOOKS -c src/portable_prescan.c -o $@

$(TEST_PORTABLE_CAPTURE_SCALE): tests/test_portable_capture_scale.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
	$(CC) $(CFLAGS) -o $@ tests/test_portable_capture_scale.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o

$(TEST_PORTABLE_PREPARE): tests/test_portable_prepare.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -DSIDECAR_TEST_HOOKS -o $@ tests/test_portable_prepare.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o

$(TEST_NATIVE_RECONCILE_SCALE): tests/test_native_reconcile_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DNATIVE_VISITED_TEST_HOOKS -o $@ tests/test_native_reconcile_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_NATIVE_HARDLINK_SCALE): tests/test_native_hardlink_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DNATIVE_VISITED_TEST_HOOKS -o $@ tests/test_native_hardlink_scale.c fileops_test.o metadata.o metadata_xattr.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o utils.o selection_match.o

$(TEST_PORTABLE_COLLISION_SCALE): tests/test_portable_collision_scale.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -o $@ tests/test_portable_collision_scale.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o

$(TEST_PORTABLE_HARDLINK_SCALE): tests/test_portable_hardlink_scale.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
...
$(TEST_PORTABLE_RESUME): tests/test_portable_resume.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
	$(CC) $(CFLAGS) -DPORTABLE_CAPTURE_TEST_HOOKS -DSIDECAR_TEST_HOOKS -o $@ tests/test_portable_resume.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar_test.o sidecar_state_test.o sidecar_state_map_test.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o

$(TEST_PORTABLE_RECONCILE): tests/test_portable_reconcile.c portable_test.o portable_reconcile_test.o portable_fsops.o portable_prescan.o portable_hashset.o fileops.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata.o metadata_xattr.o utils.o selection_match.o
...
$(TEST_PORTABLE_RESTORE_PREFLIGHT): tests/test_portable_restore_preflight.c portable_restore_replay_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup.o selfcopy.o backup_plan.o selection.o container.o fileops.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o selection_match.o
	$(CC) $(CFLAGS) -DMETADATA_TEST_HOOKS -o $@ tests/test_portable_restore_preflight.c portable_restore_replay_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup.o selfcopy.o backup_plan.o selection.o container.o fileops.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o selection_match.o
...
$(TEST_PORTABLE_RESTORE_ORCHESTRATE): tests/test_portable_restore_orchestrate.c portable_restore_replay_test.o portable_restore_preflight.o portable_restore_orchestrate.o portable_restore_shared.o fsprobe.o sidecar.o sidecar_state.o sidecar_state_map.o hash.o manifest.o encoding.o metadata_test.o metadata_xattr.o utils.o xdg.o backup_test.o selfcopy.o backup_plan.o selection.o container.o fileops.o portable.o portable_reconcile.o portable_fsops.o portable_prescan.o portable_hashset.o packages.o detect.o selection_match.o
